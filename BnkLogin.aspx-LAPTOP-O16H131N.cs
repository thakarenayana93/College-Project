...
{
    public partial class BnkLogin : System.Web.UI.Page
    {
        ...
        {            
            if (System.Web.HttpContext.Current.Session["Alert"] != null)
            {
                ...
                {
                    Page.ClientScript.RegisterStartupScript(GetType(), "msgtype", "alert('Bank Registered Successfully!!!')", true);
                    this.Session.Clear();
                }
            }
            Session["Banner"] = "BankLogin";
            Session["Login"] = "Login";
        }

        protected void btnLogin_Click(object sender, EventArgs e)
        {
            string q = "Select * from BankDetails where Username = '" + txtuname.Text + "' and Password = '" + txtpass.Text + "'";
